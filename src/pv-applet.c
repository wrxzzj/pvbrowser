/* 
 * Copyright (C) 2009 RuXu Wu, wrxzzj@gmail.com
 *
...
int main (int argc, char **argv) {
  ...
  for (i = 0; i < n_screens; i++) {
    ...
    g_signal_connect (icon, "activate", G_CALLBACK (icon_activated), NULL);

    g_signal_connect (icon, "popup-menu", G_CALLBACK (popup_menu), NULL);
